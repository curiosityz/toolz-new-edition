import { createHeroTimeline, initParallax, initGlitchEffect, scaleDownToolzOnScroll, initializeAnimations } from './modules/animations.js';
...
class App {
  ...
  async initializeApp() {
    try {
      ...
      // Initialize animations with updated scroll behavior
